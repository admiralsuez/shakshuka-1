...
export type AppSettings = {
  ...
  openInBrowser?: boolean; // prefer opening in system browser vs desktop app
  experimentalFeatures?: {
    smartTagging?: boolean; // first word becomes project/tag on spacebar
    dateShortcuts?: boolean; // show today/tomorrow/this week buttons
  };
};
